...
Route::post('/generate-story', function (Request $request) {
  $result = OpenAI::completions()->create([
    ...
    'prompt' => 'generate a 10 paragraph children story with a title and a 512x512 png image. Return a well formatted JSON object with a title property that contains the title, an img property that contains link to the image generated, a text property that contains the story and ssml property that contains an well formatted SSML document generated from the story serialized as a string. Serialized the JSON object as a string.',
    'temperature' => 1,
    'max_tokens' => 2048
 ]);
